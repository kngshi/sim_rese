...
<header class="header">
    <div class="header__inner">
        <a href="#modal-01"><div class="openbtn6"><span></span><span></span><span></span></div></a>
...
<x-auth-card>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <table>
            ...
            <td class="form-input">
                <x-input id="email" class="block mt-4 w-full border-none" type="email" name="email" :value="old('email')" placeholder="Email" required />
            </td>
            </tr>
            <tr>
            <th class="form-icon">
